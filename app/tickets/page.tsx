    ...
    <>
      ...
      <div style={{minHeight:'100vh',background:T.bg,color:T.text,fontFamily:"system-ui,sans-serif"}}>
        ...
        <main id="main-content" style={{maxWidth:640,margin:'0 auto',padding:'28px 20px 60px'}}>
          ...
          {settings.about_text&&(
            <div style={{marginBottom:28,padding:'16px 18px',background:T.card,border:`1px solid ${T.border}`,borderRadius:12,fontSize:14,color:'#a0c090',lineHeight:1.7,borderLeft:`3px solid ${T.accent}`}}>
              {settings.about_text}
            </div>
          )}
